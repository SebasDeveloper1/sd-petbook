...
export function HeroSection({ petInfo = {} }) {
  ...
  return (
    <section className="w-full bg-slate-900">
      <div className="relative grid grid-cols-2 gap-4 md:w-11/12 mx-auto pb-12 md:pb-0 min-h-[500px]">
        <div className="order-2 md:order-1 col-span-2 md:col-span-1 flex flex-col items-center md:items-start w-full md:py-12 bg-BlurCyan bg-contain bg-no-repeat">
        ...
        <figure className="relative order-1 md:order-2 overflow-hidden col-span-2 md:col-span-1 w-full md:h-full">
          <img
          ...
          <div className="absolute top-0 left-full -translate-x-8 w-full h-full">
            <div className="w-8 h-full bg-gradient-to-l from-slate-900/70 to-transparent" />
          </div>
        </figure>
      </div>
    </section>
